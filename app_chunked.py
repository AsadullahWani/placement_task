...
def extract_claims(agent, pdf_text: str) -> list[dict]:
    """
    Extract claims using document chunking to avoid request_too_large errors.
    """
    CHUNK_SIZE = 8000
    ...
    for chunk in chunks:
        prompt = f"""From the document chunk below, extract up to 5 specific verifiable factual claims.
